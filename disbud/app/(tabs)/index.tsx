...
import { View, Text, TouchableOpacity, StyleSheet, Alert, ActivityIndicator, Platform, Linking } from 'react-native';
...
export default function HomeScreen() {
  ...
  const sendDistressSignal = async () => {
    ...
    try {
      ...
      const message = `EMERGENCY: ${userName} needs immediate help! Current location: ${googleMapsUrl}`;
